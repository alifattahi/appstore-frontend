...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: n_ytIis6k_AZ/css
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__cvC90)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__hJXo)}
              />
            </React.Fragment>
          ),
          value: args.children
